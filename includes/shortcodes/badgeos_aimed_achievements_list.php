 ...
 * @since 1.4.0
 */
function badgeos_register_aimed_achievements_list_shortcode() {
	...
	badgeos_register_shortcode( array(
		'name'            => __( 'Aimed Achievement', 'badgeos' ),
		'description'     => __( 'Output a list of aimed achievements.', 'badgeos' ),
		'slug'            => 'badgeos_aimed_achievements_list',
		'output_callback' => 'badgeos_aimed_achievements_list_shortcode',
		'attributes'      => array(
			'type' => array(
            ...
            'aimed' => array(
                'name'       => __( 'Aimed Achievements', 'badgeos' ),
                'description'=> __( 'Display aimed Achievements', 'badgeos' ),
				'type'        => 'select',
				'values'      => array(
					'true'  => __( 'True', 'badgeos' ),
					'false' => __( 'False', 'badgeos' )
...
add_action( 'init', 'badgeos_register_aimed_achievements_list_shortcode' );
 ...
 */
function badgeos_aimed_achievements_list_shortcode( $atts = array () ){
